    ...
    return (
        <div>
            <div className='max-w-[1200px] mx-auto text-center'>
                ...
                <button onClick={() => setProductbtn("cart")} className={`${productbtn === "cart" ? "py-3.5 px-6 text-white bg-linear-to-r from-violet-600 to-purple-600 rounded-full text-base font-bold cursor-pointer transition-transform duration-150 active:scale-95" : "px-8 py-3.5 font-medium text-base text-black bg-white cursor-pointer transition-transform duration-150 active:scale-95"} `}>Cart ({cartdata.length})</button>
            </div>
            
            <div className='max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-7 mt-10 mb-28'>
                
                {
                    ...
                    }) : <Carts cartdata={cartdata} setCartData={setCartData} setCartCount={setCartCount} cartCount={cartCount}></Carts>
